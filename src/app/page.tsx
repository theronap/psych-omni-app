...
export default function Home() {
  return (
    <div className="min-h-screen bg-stone-950 text-stone-50">
      <nav className="border-b border-stone-900 px-6 py-5">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <span className="font-bold text-lg tracking-tight">Psych</span>
          <Link href="/intake" className="text-sm text-stone-400 hover:text-stone-100 transition-colors">
            Start analysis →
          </Link>
        </div>
      </nav>
      ...
      <section className="max-w-5xl mx-auto px-6 pt-24 pb-20">
        <div className="max-w-3xl">
          <div className="text-xs font-mono text-stone-500 mb-6 uppercase tracking-widest">
            Deep Personality Analysis
          </div>
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold leading-[1.05] mb-8">
            Understand yourself<br />
            <span className="text-stone-500">like never before.</span>
          </h1>
          <p className="text-xl text-stone-400 leading-relaxed mb-10 max-w-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
            ...
            <p className="text-stone-600 text-sm">Free during beta · ~40 minutes</p>
          </div>
        </div>
      </section>

      <section className="border-t border-stone-900 py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <p className="text-xs font-mono text-stone-500 mb-12 uppercase tracking-widest">What the report covers</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={title} className="p-6 border border-stone-800 rounded-2xl">
                <Icon size={24} className="text-amber-500 mb-4" />
                <h3 className="font-semibold text-stone-50 mb-2">{title}</h3>
      ...
      <section className="border-t border-stone-900 py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <p className="text-xs font-mono text-stone-500 mb-12 uppercase tracking-widest">Report sections</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-2xl">
            {[
              ...
              <div key={s} className="flex items-center gap-4 py-4 border-b border-stone-900">
                <span className="text-stone-700 font-mono text-sm">{String(i + 1).padStart(2, '0')}</span>
                <span className="text-stone-300 text-sm">{s}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="border-t border-stone-900 py-20 px-6 bg-stone-900/30">
        <div className="max-w-5xl mx-auto">
          <p className="text-xs font-mono text-stone-500 mb-6 uppercase tracking-widest">Built on</p>
          <div className="flex flex-wrap gap-3">
            {[
              ...
              <span key={f} className="px-4 py-2 border border-stone-700 rounded-full text-stone-400 text-xs">
                {f}
              </span>
            ))}
          </div>
      ...
      <section className="border-t border-stone-900 py-24 px-6">
      ...
      <footer className="border-t border-stone-900 px-6 py-8">
        <div className="max-w-5xl mx-auto flex items-center justify-between text-stone-600 text-xs">
