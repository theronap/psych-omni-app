    ...
    <div className="min-h-screen bg-stone-950 text-stone-50">
      <div className="border-b border-stone-800 px-6 py-4">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 text-stone-400 hover:text-white transition-colors text-sm">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 border-b border-stone-800">
        <div className="text-xs font-mono text-stone-500 mb-4 uppercase tracking-widest">Your Analysis</div>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10 border-b border-stone-800">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          {sections.map((s, i) => (
            <a key={i} href={`#section-${i}`} className="text-stone-400 hover:text-white text-sm transition-colors py-1">
      ...
      <div className="border-t border-stone-800 px-6 py-16">
        <div className="max-w-3xl mx-auto text-center">
          <div className="text-xs font-mono text-stone-500 mb-4 uppercase tracking-widest">What's Next</div>
          ...
          {emailSaved && (
            <p className="text-stone-500 text-sm mt-4">Your report is saved. You can come back to it anytime.</p>
          )}
        </div>
      </div>
    </div>
