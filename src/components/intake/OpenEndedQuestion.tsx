  ...
  return (
    <div className="space-y-6">
      ...
      <textarea
        ...
        rows={8}
        className="w-full bg-white border border-stone-200 rounded-xl p-4 text-stone-900 placeholder-stone-300 focus:outline-none focus:border-accent resize-none text-sm leading-relaxed"
      />
